...
use App\Model\GpCollector;
use Closure;
use JWTAuth;
use Tymon\JWTAuth\Exceptions\JWTException;

class JWTGPCollectorAuth
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        try{
            ...
            if($user->env == config('app.env') && $user->type == 'gp_collector') {
                $tokenIsValid = GpCollector::find($user->sub);
                ...
                $request->gp_collector = $tokenIsValid;
                return $next($request);
            }
